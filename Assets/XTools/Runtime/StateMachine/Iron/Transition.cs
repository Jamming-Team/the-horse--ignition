...
namespace XTools.SM.Iron {
    ...
    // public class ActionPredicateCompareEventBus<T> : IPredicate where T : IEvent {
    //     bool _flag;
    //     T _referenceObject;
    //
    //     public ActionPredicateCompareEventBus(ref EventBinding<T> eventReaction, T referenceObject) {
    //         _referenceObject = referenceObject;
    //         eventReaction += delegate(T compareObject) { _flag = _referenceObject.Equals(compareObject); };
    //     }
    //
